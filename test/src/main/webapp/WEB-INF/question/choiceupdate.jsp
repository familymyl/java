...
<div id="main">
    ...
    <table id="tb1">
    		...
    		<c:forEach items="${options }" var="o">
    			<tr>
	    			<td><textarea name="options" class="del" rows="2" cols="20">${o.options }</textarea></td>
	...
	<h2>编辑答案</h2>
     <table align="center">
            <tr><td align="right"><input type="text" name="cwhAnswer" value="${cwAnswer.answer }"/></td></tr>
      </table>
	</div>
</div>
